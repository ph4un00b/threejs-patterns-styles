...
void main()
{
  ...
  float elevation = sin(modelPosition.x * uleverX + utime) * uleverA * uleverB;
  elevation += sin(modelPosition.y * uleverY + utime) * uleverA * uleverC;
...
void main() {
  // gl_FragColor.rgba = vec4(vUv.x, vUv.y, 1.0, 1.0);
  gl_FragColor.rgba = vec4(vUv, 0.5, 1.0);
